...
class DefaultController extends Controller
{
    ...
    public function portadaAction($ciudad,$tienda) {
        ...
        $tienda = $em->getRepository('TiendaBundle:Tienda')->findOneBy(array('slug'=>$tienda,'ciudad'=>$ciudad->getId()));
        ...
        return $this->render('TiendaBundle:Default:portada.html.twig', array('tienda'=>$tienda,'ofertas'=>$ofertas,'cercanas'=>$cercanas));
    }
}
